...
web3FirstChain = new Web3(new Web3.providers.HttpProvider('http://localhost:8545'));
web3SecondChain = new Web3(new Web3.providers.HttpProvider('http://localhost:7545'));
