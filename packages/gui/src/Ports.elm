...
-- Called when an exchange has successfully been processed
port acceptBidSuccess : (() -> msg) -> Sub msg

-- Called when an exchange has failed
port acceptBidFailure : (String -> msg) -> Sub msg
